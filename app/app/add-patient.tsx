...
const styles = StyleSheet.create({
  ...
  inputWrap: { flexDirection: 'row', alignItems: 'center', height: 48, backgroundColor: '#FFF', borderRadius: radius.sm, paddingHorizontal: 12, borderWidth: 1, borderColor: colors.border },
  inputWrapMultiline: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: '#FFF', borderRadius: radius.sm, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: colors.border },
