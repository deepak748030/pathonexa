...
const styles = StyleSheet.create({
  ...
  input: { height: 48, borderWidth: 1.5, borderColor: colors.inputBorder, borderRadius: radius.md, paddingHorizontal: 12, fontFamily: fonts.medium, fontSize: 14, color: colors.foreground, backgroundColor: colors.inputBg },
  save: { height: 46, backgroundColor: colors.primary, borderRadius: radius.md, alignItems: 'center', justifyContent: 'center', marginTop: 4 },
  saveText: { color: '#fff', fontFamily: fonts.bold, fontSize: 14 },
  search: { flexDirection: 'row', alignItems: 'center', height: 44, backgroundColor: colors.card, borderRadius: radius.md, paddingHorizontal: 12, borderWidth: 1, borderColor: colors.border, marginBottom: 10 },
